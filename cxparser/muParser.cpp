...
value_type Parser::Log2(value_type v)  { return log(v)/log((value_type)2); }
value_type Parser::Log10(value_type v) { return log10(v); }
value_type Parser::Ln(value_type v)    { return log(v);   }
