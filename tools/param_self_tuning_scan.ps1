...
$RUN_ROOT = "D:\Codex-WorkDir\Sean_WorkDir\cxvisionai\cxscript_runs\findline_scan"
...
foreach ($img in $images) {
    ...
    for ($y = 50; $y -le 450; $y += 5) {
        ...
        if ($FIT -eq $true -and $POINTS -ge 5) {
            $best_y = $y
            $best_points = $POINTS
